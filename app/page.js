...
const testimonials = [
  {
    quote: 'Chương trình đào tạo rất thực tế và đi sâu vào những vấn đề cán bộ chúng tôi thường gặp. Giảng viên có kinh nghiệm thực chiến, giải đáp tận tình.',
    author: 'Học viên K12',
    title: 'Chuyên viên Kế hoạch',
    org: 'Cơ quan nhà nước tại Bình Dương',
  },
  {
    ...
    author: 'Học viên K11',
    title: 'Chuyên viên đấu thầu',
    org: 'Ngân hàng thương mại tại Hà Nội',
  },
  {
    quote: 'YDC Academy đã hỗ trợ đào tạo toàn bộ phòng ban liên quan trong một lần, lịch học linh hoạt, không ảnh hưởng tiến độ công việc.',
    author: 'Đại diện tổ chức',
    title: 'Phòng Đấu thầu',
    org: 'Tổng công ty vận tải',
  },
  {
    quote: 'Nội dung khóa học được cập nhật theo Luật Đấu thầu mới nhất. Giảng viên phân tích từng điều khoản gắn với thực tế, giúp tránh được nhiều sai sót pháp lý.',
    author: 'Học viên K13',
    title: 'Cán bộ nghiệp vụ',
    org: 'Cơ quan bộ ngành tại Hà Nội',
  },
  {
    quote: 'Khóa học giúp cán bộ của chúng tôi tự tin hơn rất nhiều trong việc lập hồ sơ mời thầu và đánh giá hồ sơ dự thầu.',
    author: 'Đại diện tổ chức',
    title: 'Ban Quản lý dự án',
    org: 'UBND cấp tỉnh',
  },
  {
    quote: 'Tôi đánh giá cao phương pháp giảng dạy kết hợp lý thuyết và thực hành. Phần đấu thầu qua mạng được hướng dẫn rất chi tiết, sát thực tế.',
    author: 'Học viên K14',
    title: 'Nhân viên mua sắm',
    org: 'Ngân hàng thương mại',
  },
  {
    quote: 'Chất lượng giảng dạy đồng đều, tài liệu được cập nhật thường xuyên theo quy định mới. Đây là đơn vị đào tạo đáng tin cậy.',
    author: 'Đại diện tổ chức',
    title: 'Phòng Đào tạo',
    org: 'Trường đại học tại Hà Nội',
  },
  {
    quote: 'Sau khóa học, cán bộ phụ trách đấu thầu xử lý công việc nhanh hơn, ít phát sinh vướng mắc. Năng lực nội bộ được nâng cao đáng kể.',
    author: 'Đại diện tổ chức',
    title: 'Phòng Kế hoạch',
    org: 'Tập đoàn năng lượng',
  },
  {
    quote: 'Giảng viên không chỉ giảng lý thuyết mà còn chia sẻ kinh nghiệm thực tế, giúp nhận diện được những rủi ro thường gặp trong đấu thầu.',
    author: 'Học viên K12',
    title: 'Cán bộ đầu tư',
    org: 'Doanh nghiệp xây dựng',
  },
  {
    quote: 'Chương trình 2 ngày được thiết kế rất hợp lý, không dàn trải. Phần thực hành trên phần mềm đấu thầu điện tử đặc biệt hữu ích.',
    author: 'Học viên K13',
    title: 'Cán bộ văn phòng',
    org: 'UBND cấp tỉnh miền Trung',
  },
  {
    quote: 'Tỷ lệ hồ sơ đấu thầu đạt yêu cầu ngay từ lần đầu nộp tăng lên đáng kể sau khi cán bộ tham gia đào tạo.',
    author: 'Đại diện tổ chức',
    title: 'Phòng Ngân sách',
    org: 'Cơ quan bộ ngành',
  },
  {
    quote: 'Khóa đào tạo chất lượng, phù hợp với đặc thù của trường đại học và viện nghiên cứu trong quản lý dự án đấu thầu.',
    author: 'Học viên K11',
    title: 'Cán bộ kế hoạch',
    org: 'Trường đại học kỹ thuật',
  },
  {
    quote: 'Sau nhiều năm làm đấu thầu, đây là lần đầu tiên tham gia khóa học được hệ thống hóa bài bản đến vậy. Rất dễ tiếp thu.',
    author: 'Học viên K14',
    title: 'Cán bộ hành chính',
    org: 'UBND cấp tỉnh miền Nam',
  },
]
